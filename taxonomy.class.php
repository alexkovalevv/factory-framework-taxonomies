<?php
	 ...
	 * @since 1.0.0
	 */
	abstract class FactoryTaxonomies000_Taxonomy {
		...
		public function register()
		{
			...
			// type's titles
			$singularName = $this->pluralTitle
				? $this->pluralTitle
				: $this->name;
			$pluralName = $this->singularTitle
				? $this->singularTitle
				: $this->name;
		...
		private function buildLables()
		{
			...
			$labels = array(
				...
				'popular_items' => sprintf(__('Popular %1$s', 'factory_types_000'), $pluralName),
				'all_items' => sprintf(__('All %1$s', 'factory_types_000'), $pluralName),
				'parent_item' => sprintf(__('Parent %1$s', 'factory_types_000'), $singularName),
				'parent_item_colon' => sprintf(__('Parent %1$s:', 'factory_types_000'), $singularName),
				'edit_item' => sprintf(__('Edit %1$s', 'factory_types_000'), $singularName),
				'update_item' => sprintf(__('Update %1$s', 'factory_types_000'), $singularName),
				'add_new_item' => sprintf(__('Add New %1$s', 'factory_types_000'), $singularName),
				'new_item_name' => sprintf(__('New %1$s Name', 'factory_types_000'), $singularName),
				'separate_items_with_commas' => sprintf(__('Separate %1$s with commas', 'factory_types_000'), $pluralName),
				'add_or_remove_items' => sprintf(__('Add or remove %1$s', 'factory_types_000'), $pluralName),
				'choose_from_most_used' => sprintf(__('Choose from the most used %1$s', 'factory_types_000'), $pluralName),
				'not_found' => sprintf(__('No %1$s found.', 'factory_types_000'), $pluralName),
				'menu_name' => sprintf(__('%1$s', 'factory_types_000'), $pluralName),
			);
