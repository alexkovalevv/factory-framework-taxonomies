<?php
	...
	if( !class_exists('Wbcr_FactoryTaxonomies000_Taxonomy') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryTaxonomies000_Taxonomy {
			...
			public function registerForAdmin()
			{
				...
				/*add_action("{$this->name}_pre_edit_form", function () {
					echo '<div class="factory-bootstrap-000 factory-fontawesome-000">';
				});
			...
			private function buildLables()
			{
				...
				$labels = array(
					...
					'search_items' => sprintf(__('Search %1$s', 'factory_types_000'), $plural_name),
					'popular_items' => sprintf(__('Popular %1$s', 'factory_types_000'), $plural_name),
					'all_items' => sprintf(__('All %1$s', 'factory_types_000'), $plural_name),
					'parent_item' => sprintf(__('Parent %1$s', 'factory_types_000'), $singular_name),
					'parent_item_colon' => sprintf(__('Parent %1$s:', 'factory_types_000'), $singular_name),
					'edit_item' => sprintf(__('Edit %1$s', 'factory_types_000'), $singular_name),
					'update_item' => sprintf(__('Update %1$s', 'factory_types_000'), $singular_name),
					'add_new_item' => sprintf(__('Add New %1$s', 'factory_types_000'), $singular_name),
					'new_item_name' => sprintf(__('New %1$s Name', 'factory_types_000'), $singular_name),
					'separate_items_with_commas' => sprintf(__('Separate %1$s with commas', 'factory_types_000'), $plural_name),
					'add_or_remove_items' => sprintf(__('Add or remove %1$s', 'factory_types_000'), $plural_name),
					'choose_from_most_used' => sprintf(__('Choose from the most used %1$s', 'factory_types_000'), $plural_name),
					'not_found' => sprintf(__('No %1$s found.', 'factory_types_000'), $plural_name),
					'menu_name' => sprintf(__('%1$s', 'factory_types_000'), $plural_name),
				);
