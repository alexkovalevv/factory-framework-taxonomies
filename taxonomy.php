<?php
	...
	//add_action('factory_000_plugin_activation', 'FactoryTaxonomy000::activationHook');
	//add_action('factory_000_plugin_deactivation', 'FactoryTaxonomy000::deactivationHook');
	...
	if( !class_exists('Wbcr_FactoryTaxonomies000') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryTaxonomies000 {

			/**
			 * Registered custom types.
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryTaxonomies000_Taxonomy[]
			 */
